import {displayMissionPlans} from "./mission_plan.js";
...
const missionPlanContainer = document.getElementById('mission-plan-container');
...
fetch('/api/mission_plans/')
        .then(response => response.json())
        .then(data => {
            console.log(`mission plan data: ${data}`);
            displayMissionPlans(data, missionPlanContainer);
        })
        .catch(error => console.error('Error fetching telemetry data:', error));
    ...
    item.addEventListener('click', () => {
        ...
        fetch(`/storage?satellite_name=${selectedSatellite}`, {
            ...
            .then(data => {
                ...
                displayMissionPlans(data.mission_plan_data, missionPlanContainer);
            })
