...
'use strict';
{
    ...
    $.fn.formset = function(opts) {
        ...
        /**
         * The "Add another MyModel" button below the inline all_forms.
         */
        const addInlineAddButton = function() {
            if (addButton === null) {
                if ($this.prop("tagName") === "TR") {
                    // If all_forms are laid out as table rows, insert the
        ...
        const addInlineClickHandler = function(e) {
            ...
            // Update number of total all_forms.
        ...
        const addInlineDeleteButton = function(row) {
            if (row.is("tr")) {
                // If the all_forms are laid out in table rows, insert
